...
function CapaSec() {
  return (
    <section className="md:bg-living-room md:bg-auto md:bg-center-top xl:bg-cover xl:bg-bottom parallax md:flex md:items-center md:min-h-[716px] ">
      ...
      <article className="relative p-10 text-center flex flex-col gap-6 bg-deep-space-blue bg-opacity-90 rounded-2xl  w-11/12 mx-auto mt-5 md:h-[443px] md:w-[603px] md:items-start md:justify-center md:text-start md:pt-20 md:mr-10 xl:mt-36 section-slide-in">
        {/* container text */}
